...
function EditCustomerModal({ customer, token, setIsEditCustomerModalOpen, setCustomers, darkMode, setConfirmModalOpen, setConfirmMessage, setConfirmAction }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    setConfirmMessage('Are you sure you want to update this customer?');
    setConfirmAction(() => () => {
      fetch(`http://localhost:3000/api/customers/${customer.customer_id}`, {
        method: 'PUT',
        headers: {
