...
function Transactions({ invoices, payments, customers, darkMode, formatDate }) {
  ...
  return (
    <div>
      ...
      <input
        ...
        className="w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg px-4 py-2 mb-6 focus:ring-2 focus:ring-blue-500"
      />
